        ...
        <div onClick={() => setActiveInput("")}>
          ...
          >
            <Container style={{ margin: "10px 0px" }}>
              ...
              <Container
                style={{ border: "lightblue dotted 4px", margin: "10px 0px" }}
              >
                <Grid>
                  <div
                    style={{
                    ...
                    <Grid.Col span={4}>
                      <div>
                        ...
                        <input
                          value={info.gender}
                          onChange={(e) => {
                            setInfo({ ...info, gender: e.currentTarget.value });
                          }}
                          id="gender"
                          name="gender"
                          type="text"
                  ...
                  >
                    <Grid.Col span={4}>
                      <div>
                        <div>Job Nature</div>
                        <input
                          value={info.job_nature}
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              job_nature: e.currentTarget.value,
                            });
                          }}
                          id="job_nature"
                          name="job_nature"
                    ...
                    <Grid.Col span={4}>
                      <div>
                        ...
                        <input
                          value={info.salary}
                          onChange={(e) => {
                            setInfo({ ...info, salary: e.currentTarget.value });
                          }}
                          id="salary"
                          name="salary"
                          type="text"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              employee_type: e.currentTarget.value,
                            });
                          }}
                          id="employee_type"
                          name="employee_type"
                  ...
                  >
                    <Grid.Col span={4}>
                      <div>
                        ...
                        <input
                          value={info.annual_leave}
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              annual_leave: e.currentTarget.value,
                            });
                          }}
                          id="annual_leave"
                          name="annual_leave"
                    ...
                    <Grid.Col span={4} style={{ margin: "0px 100px" }}>
                      <div>
                        <div>Sick Leave</div>
                        <input
                          value={info.sick_leave}
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              sick_leave: e.currentTarget.value,
                            });
                          }}
                          id="sick_leave"
                          name="sick_leave"
                  ...
                  >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              bank_account: e.currentTarget.value,
                            });
                          }}
                          id="bank_account"
                          name="bank_account"
                    ...
                    <Grid.Col span={4} style={{ margin: "0px 100px" }}>
                      <div>
                        ...
                        <input
                          value={info.working_time}
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              working_time: e.currentTarget.value,
                            });
                          }}
                          id="working_time"
                          name="working_time"
                  ...
                  >
                    <Grid.Col span={4}>
                      <div>
                        ...
                        <input
                          value={info.access_level}
                          onChange={(e) => {
                            setInfo({
                              ...info,
                              access_level: e.currentTarget.value,
                            });
                          }}
                          id="access_level"
                          name="access_level"
